  ...
  <table>
    ...
    ?>
        <tr>
            ...
            <td><?php  if($rows['availability']=="available"){?><button class="issuebtn" name="submit" onclick="eventhandler(this)" value="<?php  echo $rows['bid']?>" bname="<?php echo $rows['bookname'] ?>" >Issue</button><?php } ?></td>
        </tr>
<?php
        }//end while
...
<div class="spanningbox">
    ...
    <input type="text" name="studentid" id="studentid" placeholder="21686" required >
    </div>
    <div class="input-group">
